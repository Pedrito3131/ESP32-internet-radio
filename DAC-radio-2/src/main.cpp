...
const char *WifiCredentials::SSID = "Livebox-E330";
const char *WifiCredentials::PASSWORD = "KdF2DMXQo4gFRjPiG6";

const uint8_t kPinI2S_BCLK = GPIO_NUM_12; // yellow (PCM5102A board: BCK)
const uint8_t kPinI2S_LRCK = GPIO_NUM_14; // brown (PCM5102A board: LRCK)
const uint8_t kPinI2S_SD = GPIO_NUM_13; // green (PCM5102A board: DIN)
